                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <div class="ms-auto position-relative">
                      ...
                      <input type="text" class="form-control @error('student_number') is-invalid @enderror radius-30 ps-5" id="student_number" name="student_number" placeholder="Masukkan NRP kamu" value="{{ old('student_number', auth()->user()->profile->student_number ?? '') }}">
                    </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <div class="ms-auto position-relative">
                      ...
                      <input type="text" class="form-control @error('batch') is-invalid @enderror radius-30 ps-5" id="batch" name="batch" placeholder="Masukkan angkatan kamu" value="{{ old('batch', auth()->user()->profile->batch ?? '') }}">
                    </div>
                    @error('batch')
                    <small class="text-danger">
                      {{ $message }}
